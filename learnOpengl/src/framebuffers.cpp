...
int main()
{
    ...
    Shader shader_t2("5.1.framebuffers_screen.vs", "5.1.framebuffers_text2.fs");
    ...
    unsigned int cubeTexture2 = loadTexture("res/textures/toy_box_normal.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.setBool("force_white",false);
        // cubes
        glBindVertexArray(cubeVAO);
...
//        //cubes 2
//        shader_t2.use();
//        shader_t2.setMat4("view", view);
//        shader_t2.setMat4("projection", projection);
//        shader_t2.setBool("force_white",false);
//        glBindVertexArray(cubeVAO);
//        glActiveTexture(GL_TEXTURE1);
//        model = glm::mat4(1.0f);
//        model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
//        shader_t2.setMat4("model", model);
//        glDrawArrays(GL_TRIANGLES, 6, 36);
//        glBindVertexArray(0);
